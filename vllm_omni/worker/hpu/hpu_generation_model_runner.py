...
# TODO: Change to HPU specific implementation
...
from vllm_ascend.worker.model_runner_v1 import AsyncHPUModelRunnerOutput
...
class HPUGenerationModelRunner(OmniHPUModelRunner):
    """Generation model runner for vLLM-omni on HPU (non-autoregressive)."""
